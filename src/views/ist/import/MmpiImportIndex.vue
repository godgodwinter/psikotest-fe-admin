...
function populateGrid(workbook) {
    ...
    var columns = {
        ...
        H: 'l', I: 'f', J: 'f1', K: 'f2', L: 'k', M: 'hs', N: 'd', O: 'hy', P: 'pd', Q: 'm', R: 'pa', S: 'pt', T: 'sc', U: 'ma', V: 'si',
        W: 'a_anx', X: 'a_obs', Y: 'a_dep', Z: 'a_hea', AA: 'a_aln', AB: 'a_biz', AC: 'a_ang', AD: 'a_cyn', AE: 'a_con', AF: 'a_lse', AG: 'a_las', AH: 'a_sod', AI: 'a_fam', AJ: 'a_sch', AK: 'a_trt',
        AL: 'tipe_mmpi', AM: 'anx', AN: 'frs', AO: 'obs', AP: 'dep', AQ: 'hea', AR: 'biz', AS: 'ang', AT: 'cyn', AU: 'asp', AV: 'tpa', AW: 'lse', AX: 'sod', AY: 'fam', AZ: 'wrk', BA: 'trt',
    };
...
// get Sekolah dengan Format Label yang baru
...
// get Kelas dengan Format Label KELAS yang baru
...
const doStore = async () => {
    ...
    try {
        const response = await ApiIst.post(`mmpi/hasil/import_offline`, dataForm);
        if (response.data) {
...
const columns = [
    ...
    { label: "l", field: "l", type: "Number" },
    { label: "f", field: "f", type: "Number" },
    { label: "f1", field: "f1", type: "Number" },
    { label: "f2", field: "f2", type: "Number" },
    { label: "k", field: "k", type: "Number" },
    { label: "hs", field: "hs", type: "Number" },
    { label: "d", field: "d", type: "Number" },
];
</script>
    ...
    <div class="p-4 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Import Data MMPI</h1>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="alert alert-warning shadow-sm border-none bg-yellow-50 text-yellow-800 text-xs italic">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-sm text-red-500">• MMPI A belum fix (jangan di gunakan dulu).</p>
                    </div>
                </div>
            </div>
