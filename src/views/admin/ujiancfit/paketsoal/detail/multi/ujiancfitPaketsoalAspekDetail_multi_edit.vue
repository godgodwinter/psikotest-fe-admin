...
const getDataDetail = async () => {
    try {
        const response = await ApiUjianKhusus.get(`cfit/paketsoal/${paketsoal_id.value}/multi/${aspekDetail_id.value}`);
        dataForm.value = response.data;
        // banksoal_multi_id.value = response.data.banksoal_multi_id;
...
const onSubmit = async (values) => {
    // values.banksoal_multi_id = dataForm.value.banksoal_multi_id;
    ...
    // console.log('====================================');
    try {
        const response = await ApiUjianKhusus.put(`cfit/paketsoal/${paketsoal_id.value}/multi/${aspekDetail_id.value}`, dataForm.value);
