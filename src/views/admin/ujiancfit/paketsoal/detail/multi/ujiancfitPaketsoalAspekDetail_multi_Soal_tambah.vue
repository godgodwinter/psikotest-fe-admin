...
const getData = async () => {
    try {
        const response = await ApiUjianKhusus.get(`cfit/paketsoal/${paketsoal_id.value}/multi/${aspek_detail_id.value}/soal/banksoal/${banksoal_aspek_detail_id.value}`);
        console.log('====================================');
...
const doAdd = async () => {
    ...
    const response = await ApiUjianKhusus.post(`cfit/paketsoal/${paketsoal_id.value}/multi/${aspek_detail_id.value}/soal/banksoal/${banksoal_aspek_detail_id.value}`, dataForm.value);
