...
const getData = async () => {
    try {
        const response = await ApiUjianKhusus.get(`cfit/paketsoal/${paketsoal_id.value}/umum`);
        console.log('====================================');
...
const doDeleteData = async (id, index) => {
    ...
    if (confirm("Apakah anda yakin menghapus data ini?")) {
        try {
            const response = await ApiUjianKhusus.delete(`cfit/paketsoal/${paketsoal_id.value}/umum/${id}`);
