    ...
    <span v-else>
        <div>
            <article class="prose lg:prose-sm">
                <h1>UJIAN CFIT KELAS {{ kelas_nama }} </h1>
                <h5>UJIAN CFIT - V4</h5>
            </article>
            ...
            <div>
                <p>Catatan : Paket Aktif Otomatis sesuai umur (Pastikan Paket sudah siap di menu paket soal) </p>
            </div>
         ...
         hover:bg-blue-600  tooltip" data-tip="Generate hasil v4" @click="doGenerateHasilPersiswa_v4(props.row.id)"
                                                ...
                                                <button class="btn btn-sm  bg-emerald-500 text-white 
         hover:bg-emerald-600  tooltip" data-tip="Generate UJIAN CFIT v3" @click="doGenerateSiswa(props.row.id)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-6 h-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
