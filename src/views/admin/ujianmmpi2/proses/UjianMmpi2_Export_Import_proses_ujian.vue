...
const columns = [
    ...
    {
        label: "R:Soal",
        field: "v4_ujian_mmpi2_getJawabanBySiswaMapel_multi",
        type: "String",
    },
    {
        label: "M:Proses",
    ...
    {
        label: "M:ProsesShort",
        field: "mmpi2_proses_short",
        type: "String",
    },
    {
        label: "R:Proses",
        field: "mmpi2_proses_redis",
        type: "String",
    },
    {
        label: "R:ProsesShort",
        field: "mmpi2_proses_short_redis",
        type: "String",
    },
    {
...
const fn_download_file = async (skipConfirm = false) => {
    ...
    try {
        ...
        let filename = `zst_mmpi2_backup_${sekolahNama}_${kelasNama}_total_siswa_${jmlSiswa}_${dateFormatted}.json.zst`;
                            ...
                            <div v-if="data">
                                <vue-good-table :line-numbers="true" :columns="columns" :rows="data" :search-options="{
                                    ...
                                    <template #table-row="props">
                                        ...
                                        <span v-else-if="props.column.field == 'mmpi2_proses'"
                                            class="flex items-center gap-1">
                                            <svg v-if="props.row?.mmpi2_proses" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span v-else-if="props.column.field == 'mmpi2_proses_short'"
                                            class="flex items-center gap-1">
                                            <svg v-if="props.row?.mmpi2_proses_short" xmlns="http://www.w3.org/2000/svg"
                                                class="h-5 w-5 text-green-600" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        ...
                                        <span v-else-if="props.column.field == 'mmpi2_proses_redis'"
                                            class="flex items-center gap-1">
                                            <svg v-if="props.row?.mmpi2_proses_redis" xmlns="http://www.w3.org/2000/svg"
                                                class="h-5 w-5 text-green-600" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        ...
                                        <span v-else-if="props.column.field == 'mmpi2_proses_short_redis'"
                                            class="flex items-center gap-1">
                                            <svg v-if="props.row?.mmpi2_proses_short_redis"
                                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-600"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
