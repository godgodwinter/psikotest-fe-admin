...
const getData = async () => {
    try {
        const response = await ApiUjianKhusus.get(`ujiankhusus/paketsoal/${paketsoal_id.value}/aspek_detail/${aspek_detail_id.value}/soal/banksoal/${banksoal_aspek_detail_id.value}`);
