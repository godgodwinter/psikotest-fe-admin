...
const onSubmit = async (values) => {
    ...
    try {
        const response = await ApiUjianKhusus.post(`ujiankhusus/minatbakat/banksoal/index`, dataFormSend);
                        ...
                        <div class="max-w-xs py-2">
                            <div class="form-control">
                                <label class="label cursor-pointer">
                                    ...
                                    <input type="checkbox" class="toggle" v-model="dataForm.random_kelompok" name="randomSoal" />
                                </label>
                            </div>
                        </div>
                    </div>
