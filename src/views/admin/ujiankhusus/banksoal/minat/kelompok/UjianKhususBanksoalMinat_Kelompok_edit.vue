...
const getDataDetail = async () => {
    try {
        const response = await ApiUjianKhusus.get(`ujiankhusus/minatbakat/banksoal/index/${banksoal_minatbakat_id.value}/kelompok/${kelompok_id.value}`);
        dataDetail.value = response.data;
        console.log(dataDetail.value);
        dataForm.value.kelompok_nama = response.data.kelompok_nama;
        dataForm.value.kelompok_desc = response.data.kelompok_desc;
...
const onSubmit = async (values) => {
    ...
    try {
        const response = await ApiUjianKhusus.put(`ujiankhusus/minatbakat/banksoal/index/${banksoal_minatbakat_id.value}/kelompok/${kelompok_id.value}`, dataFormSend);
        // console.log(response);
        Toast.success("Info", "Data berhasil ditambahkan!");
        router.push({ name: "admin-ujiankhusus-banksoal-minat-kelompok" });
        return true;
    } catch (error) {
        console.error(error);
    }
