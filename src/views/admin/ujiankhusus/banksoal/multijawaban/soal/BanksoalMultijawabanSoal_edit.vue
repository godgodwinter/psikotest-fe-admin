...
const getDataDetail = async () => {
    try {
        const response = await ApiUjianKhusus.get(`cfit/banksoal/aspek_detail/${aspek_detail_id.value}/soal/${soal_id.value}`);
        ...
        dataForm.value.skor_jawaban_benar = dataDetail.value.skor_jawaban_benar;
...
const onSubmit = async (values) => {
    ...
    values.skor_jawaban_benar = dataForm.value.skor_jawaban_benar;
    ...
    if (doSubmit > 0) {
        ...
        const response = await ApiUjianKhusus.put(
            `cfit/banksoal/aspek_detail/${aspek_detail_id.value}/soal/${soal_id.value}`,
            inputForm
        );
        ...
        <Form v-slot="{ errors }" @submit="onSubmit">
            <div class="py-2 lg:py-4 px-4">
                ...
                <div class="flex flex-col">
                    ...
                    <div>
                        <Field v-model="dataForm.skor_jawaban_benar" name="skor_jawaban_benar" type="number"
                            class="py-2 px-3 w-full lg:w-1/2 mx-auto md:mx-0 input input-bordered" />
                        <div class="text-xs text-red-600 mt-1">
                            {{ errors.skor_jawaban_benar }}
                        </div>
                    </div>
                </div>
                                ...
                                <div class="space-y-4 py-1 px-4">
                                    <div class="flex flex-col">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex flex-col">
                                                <div class="max-w-xs py-0">
                                                    <div class="form-control">
                                                        <label class="label cursor-pointer">
                                                            <span class="label-text">Status Jawaban</span>
                                                            <input type="checkbox" class="toggle"
                                                                v-model="dataPilihanJawaban[index].status_jawaban"
                                                                :name="status_jawaban + '[' + index + ']'" />
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
