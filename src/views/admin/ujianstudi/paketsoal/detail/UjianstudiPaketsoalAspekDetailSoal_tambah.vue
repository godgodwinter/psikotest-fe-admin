...
const getData = async () => {
    try {
        const response = await Api.get(`/ujianstudi/banksoal/aspek_detail/${banksoal_aspek_detail_id}/soal`);
...
const doAdd = async () => {
    ...
    const response = await Api.post(
        `ujianstudi/paketsoal/${paketsoal_id.value}/aspek_detail/${aspek_detail_id.value}/soal`,
        dataForm.value
    );
