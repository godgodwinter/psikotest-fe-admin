        ...
        <div class="bg-white px-2 hover:shadow shadow-sm">
            ...
            <div class="">
                ...
                <ul class="space-y-0 pb-2 lg:flex flex-wrap px-0 gap-0 justify-between">
                    ...
                    <li class="bg-white lg:w-full py-0">
                        <router-link
                            :to="{ name: 'admin-sekolah-submenu-ujianhspq_only-v4', params: { sekolah_id, kelas_id } }"
                            class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
                            ...
                            <span class="ml-1">Ujian HSPQ </span>
                        </router-link>
                    </li>
                    <li class="bg-white lg:w-full py-0">
                        <router-link
                            :to="{ name: 'admin-sekolah-submenu-ujianminat_only-v4', params: { sekolah_id, kelas_id } }"
                            class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
                            ...
                            <span class="ml-1">Ujian MINAT </span>
                        </router-link>
                    </li>
                    <li class="bg-white lg:w-full py-0">
                        <router-link
                            :to="{ name: 'admin-sekolah-submenu-ujianist-v4', params: { sekolah_id, kelas_id } }"
                            class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
                            ...
                            <span class="ml-1">Ujian IST </span>
                        </router-link>
                    </li>
                    <li class="bg-white lg:w-full py-0">
                        <router-link
                            :to="{ name: 'admin-sekolah-submenu-ujianhspq_ist_minat-v4', params: { sekolah_id, kelas_id } }"
                            class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
                            ...
                            <span class="ml-1">Ujian IST+HSPQ+MINAT </span>
                        </router-link>
                    </li>
                    <li class="bg-white lg:w-full py-0">
                        <router-link
                    ...
                    <li class="bg-white lg:w-full py-0">
                        <router-link
                            :to="{ name: 'admin-sekolah-submenu-ujian_tiki_m', params: { sekolah_id, kelas_id } }"
                            class="text-base-content font-normal rounded-lg flex items-center p-2 group hover:link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
                            ...
                            <span class="ml-1">UJIAN TIKI M </span>
                        </router-link>
                    </li>
                    <!-- <li class="bg-white lg:w-full py-0">
                        <router-link
