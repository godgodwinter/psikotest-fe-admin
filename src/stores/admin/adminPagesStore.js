...
export const useAdminPagesStore = defineStore("adminPagesStore", () => {
  ...
  const superadmin = ref(
    localStorage.getItem("superadmin_001")
      ? localStorage.getItem("superadmin_001")
      : false
  );
  // Getter Setter
  ...
  // State
  const pages_sekolah_aktif = ref(
    localStorage.getItem("pages_sekolah_aktif")
      ? JSON.parse(localStorage.getItem("pages_sekolah_aktif"))
      : null
  );
  ...
  const ujianstudi_pengaturan = ref(
    localStorage.getItem("pages_ujianstudi_pengaturan")
      ? JSON.parse(localStorage.getItem("pages_ujianstudi_pengaturan"))
